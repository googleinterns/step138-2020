...
public class Parse {
    ...
    private static List<Post> parsePosts(Entity repEntity) throws EntityNotFoundException{
    ...
    private static Post parsePost(Entity postEntity) throws EntityNotFoundException{
